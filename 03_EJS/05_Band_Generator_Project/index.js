...
app.post("/submit", (req, res) => {
  ...
  const ranIndexAdj = Math.floor(Math.random()*adj.length);
  const ranIndexNoun = Math.floor(Math.random()*noun.length);

  const randomAdj = adj[ranIndexAdj];
  const randomNoun = noun[ranIndexNoun];
